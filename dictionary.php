...
<!-- Ex. 1: File of Dictionary -->
	<?php $filename = file('C:\MAMP\htdocs\dictionary.tsv'); 
		  $filesize = filesize('C:\MAMP\htdocs\dictionary.tsv')
    ...
    <p>
        My dictionary has <?= count($filename) ?> total words
        and
